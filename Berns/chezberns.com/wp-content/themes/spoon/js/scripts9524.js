...
jQuery(window).load(function () {
	...
	// Traduire le "READ MORE" en "LIRE PLUS"
	jQuery('.more-link').text("Lire plus");

	// Modifier les liens des 3 images dans la partie "Nos Prestations" (sur la home page), 
	// pour les faire rediriger vers la page en question plutot que sur une gallerie.

	// Redirection vers page 'Votre mariage'
	jQuery(".gallery-thumb a[href='http://bern.alhena-dev.com/gallery/mariage/']").attr('href', 'http://bern.alhena-dev.com/mariages/');
	// Redirection vers page 'Vos évènements privés'
	jQuery(".gallery-thumb a[href='http://bern.alhena-dev.com/gallery/receptions/']").attr('href', 'http://bern.alhena-dev.com/receptions/');
	// Redirection vers page 'Vos évènements professionnels'
	jQuery(".gallery-thumb a[href='http://bern.alhena-dev.com/gallery/evenements-pro/']").attr('href', 'http://bern.alhena-dev.com/evenements-pro/');
